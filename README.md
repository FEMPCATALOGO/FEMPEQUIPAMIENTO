...
| -------- | -------- | --------- | ---------- | --------------- | -------- | --------- | -------- | --------- | ---------- | 
| Urbanismo e infraestructuras   Equipamientos | Terminado | *[Página web](http://vocab.linkeddata.es/datosabiertos/def/urbanismo-infraestructuras/equipamiento-municipal/index-en.html)* *[Repositorio](https://github.com/opencitydata/sociedad-bienestar-equipamientos-municipales)*  |  *[Generar issue](https://github.com/opencitydata/sociedad-bienestar-equipamientos-municipales/issues)*   | 	Vocabulario para la representación de datos de equipamientos de una ciudad. Este vocabulario ha sido desarrollado en el contexto del grupo CTN178 GT3.1 sobre datos abiertos y ciudades inteligentes. El estado del vocabulario es todavía muy inicial y sufrirá cambios, sobre todo relacionados con la inclusión de nuevos tipos de equipamientos que por sus características sea interesante incluir explícitamente. |  | eseqmu | rdf+xml   html   turtle  | CC-BY  | es  |
